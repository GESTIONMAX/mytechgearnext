        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-md">
                Découvrez nos collections de lunettes intelligentes et sportives. Innovation, style et performance
                réunis dans chaque modèle.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <Link href="/sport">
                <Card className="transition-smooth hover:shadow-elegant hover:-translate-y-2 cursor-pointer">
              ...
              <Link href="/lifestyle">
                <Card className="transition-smooth hover:shadow-elegant hover:-translate-y-2 mt-4 cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <Image
              ...
              <Link href="/prismatic">
                <Card className="transition-smooth hover:shadow-elegant hover:-translate-y-2 mt-8 cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <Image
