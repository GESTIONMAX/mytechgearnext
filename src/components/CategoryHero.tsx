...
const CategoryHero: React.FC<CategoryHeroProps> = ({ category }) => {
  const getCategoryData = (cat: string): void => {
    ...
    switch (categoryLower) {
      case 'sport':
        return {
          ...
          description:
            'Lunettes connectées conçues pour les sportifs exigeants. Résistance, précision des données et confort optimal pour repousser vos limites.',
      ...
      case 'lifestyle':
        return {
          ...
          description:
            "L'alliance parfaite entre style et technologie. Des lunettes connectées qui s'intègrent naturellement à votre quotidien urbain.",
      ...
      case 'prismatic':
        return {
          ...
          description:
            "Innovation révolutionnaire : des verres qui s'adaptent à votre environnement et votre style. Couleurs et opacité entièrement personnalisables.",
      ...
      default:
        return {
          ...
          description:
            'Découvrez notre collection exclusive de lunettes connectées alliant technologie de pointe et design contemporain.',
      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl text-white">
            ...
            {/* Title */}
            <h1 className="font-merriweather text-4xl lg:text-6xl font-bold mb-4 leading-tight">{data.title}</h1>

            {/* Subtitle */}
            <p className="text-xl lg:text-2xl text-gray-200 mb-6 font-light">{data.subtitle}</p>

            {/* Description */}
            <p className="text-lg text-gray-300 mb-8 max-w-xl leading-relaxed">{data.description}</p>
