...
import { Star, ShoppingCart, Heart, Share2, ArrowLeft, Music, CheckCircle, Shield, Truck, Award } from 'lucide-react';
import Image from 'next/image';
import Link from 'next/link';

export default function MusicShieldProductPage(): React.JSX.Element {
  const product = {
    id: 'music-shield',
    name: 'Music Shield',
    description: 'Tint-adjustable sports sunglasses with built-in audio',
    fullDescription:
      'The ultimate sports companion featuring built-in audio and tint-adjustable lenses. Perfect for running, cycling, and outdoor activities with crystal-clear sound and adaptive vision protection.',
    price: 260,
    originalPrice: null,
    rating: 4.7,
    reviews: 327,
    ...
    features: [
      ...
      'Tint-adjustable Eclipse™ Lenses',
      'Waterproof IPX7',
      '8-hour battery life',
      'Touch controls',
      'Sports-optimized fit',
      'UV400 protection',
      'Magnetic charging',
    ],
    specifications: {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              {product.images.map((image, index) => (
                <div
                  key={index}
                  className="relative w-full h-24 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg overflow-hidden cursor-pointer hover:opacity-80 transition-opacity"
                >
