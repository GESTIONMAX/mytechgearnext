...
export const blogPosts: BlogPost[] = [
  // Articles SPORT
  {
    ...
    excerpt:
      'Découvrez comment les cyclistes professionnels utilisent les lunettes connectées pour améliorer leurs performances et optimiser leur entraînement.',
    ...
    seo: {
      ...
      metaDescription:
        'Comment les cyclistes pros utilisent les lunettes connectées pour améliorer performances. Guide complet avec tests et recommandations.',
    },
  },
  {
    id: 'sport-2',
    ...
    excerpt:
      'Guide complet pour choisir les meilleures lunettes connectées adaptées au trail running et aux sports outdoor.',
  ...
  },
  {
    ...
    excerpt:
      "Comparatif détaillé entre l'audio intégré dans les lunettes connectées et les écouteurs traditionnels pour le sport.",
  ...
  // Articles LIFESTYLE
  {
    ...
    excerpt:
      'Comment intégrer les lunettes connectées dans votre quotidien professionnel pour allier style, confort et productivité.',
    ...
    seo: {
      ...
      metaDescription:
        'Optimisez votre productivité au bureau avec les lunettes connectées. Guide complet style, confort et fonctionnalités pro.',
    },
  },
  {
    id: 'lifestyle-2',
    ...
    excerpt:
      'Analyse des dernières tendances en matière de lunettes connectées et leur adoption croissante dans le lifestyle quotidien.',
  ...
  },
  {
    ...
    excerpt:
      "Comment les lunettes connectées transforment l'expérience urbaine : navigation, notifications et interactions sociales.",
  ...
  // Articles PRISMATIC
  {
    ...
    excerpt:
      'Plongez dans la technologie révolutionnaire des verres prismatiques et découvrez comment ils changent la couleur en temps réel.',
    ...
    seo: {
      ...
      metaDescription:
        'Découvrez la technologie des verres prismatiques qui changent de couleur. Science, innovation et applications futures expliquées.',
    },
  },
  {
    id: 'prismatic-2',
